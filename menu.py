...
def main():
    ...
    main_menu_items = ["[1] Install ansible", "[2] Edit hosts file", "[3] Edit variables file", "[4] Install swarm cluster (Production)", "[5] Install swarm cluster only one node (Test)", "Quit"]
    main_menu_cursor = ">> "
    ...
    install_swarm_items = ["[1] Install multi-manage multi-worker cluster *", "[2] Install manager reachable", "[3] Install worker", "[4] Iake token", "Back to Main Menu"]
